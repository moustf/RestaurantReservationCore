...
async Task CrudOperateOnEntities(RestaurantContext context)
{
    ...
    await crudOperate.AddNewCustomer(new Customer()
    {
        FirstName = "Mohammed",
        LastName = "Salem",
        Email = "test@test.com",
    ...
    await crudOperate.DeleteCustomer(await context.Customers.FirstAsync(c => c.Email == "test@test.com"));
    ...
    await crudOperate.AddNewCustomer(initialCustomer);
    ...
    await crudOperate.UpdateCustomer(customerToUpdateWith);
    ...
    await crudOperate.DeleteCustomer(updatedCustomer!);
    ...
    await crudOperate.AddNewRestaurant(new Restaurant()
    {
        Name = "Restaurant One",
    ...
    await crudOperate.DeleteRestaurant(await context.Restaurants.FirstAsync(c => c.PhoneNumber == "11223344"));
    ...
    await crudOperate.AddNewRestaurant(initialRestaurant);
    ...
    await crudOperate.UpdateRestaurant(restaurantToUpdateWith);
    ...
    await crudOperate.DeleteRestaurant(await context.Restaurants.FirstAsync(c => c.RestaurantId == restaurantToUpdateWith.RestaurantId));
    ...
    await crudOperate.AddNewEmployee(new Employee()
    {
        FirstName = "Mohammed",
        LastName = "Salem",
        Position = "Manager",
    ...
    await crudOperate.DeleteEmployee(await context.Employees.FirstAsync(e => e.FirstName == "Mohammed" && e.LastName == "Salem"));
    ...
    await crudOperate.AddNewEmployee(initialEmployee);
    ...
    await crudOperate.UpdateEmployee(employeeToUpdateWith);
    ...
    await crudOperate.DeleteRestaurant(await context.Restaurants.FirstAsync(r => r.RestaurantId == restaurantThree!.RestaurantId));
    ...
    await crudOperate.AddNewMenuItem(new MenuItem()
    {
        Name = "Coffee Machine",
    ...
    await crudOperate.DeleteMenuItem(await context.MenuItems.FirstAsync(m => m.Name == "Coffee Machine" && m.Description == "Coffee grinding machine"));
    ...
    await crudOperate.AddNewMenuItem(initialMenuItem);
    ...
    await crudOperate.UpdateMenuItem(menuItemToUpdateWith);
    ...
    await crudOperate.DeleteRestaurant(await context.Restaurants.FirstAsync(r => r.RestaurantId == restaurantFour.RestaurantId));
    ...
    await crudOperate.AddNewTable(new Table()
    {
        Capacity = 8,
    ...
    await crudOperate.DeleteTable(await context.Tables.FirstAsync(t => t.TableId == table.TableId));
    ...
    await crudOperate.AddNewTable(initialTable);
    ...
    await crudOperate.UpdateTable(tableToUpdateWith);
    ...
    await crudOperate.DeleteRestaurant(await context.Restaurants.FirstAsync(r => r.RestaurantId == restaurantFive.RestaurantId));
    ...
    await crudOperate.AddNewReservation(new Reservation()
    {
    ...
    await crudOperate.DeleteReservation(await context.Reservations.FirstAsync(r => r.ReservationId == reservationOne.ReservationId));
    ...
    await crudOperate.AddNewReservation(initialReservation);
    ...
    await crudOperate.UpdateReservation(reservationToUpdateWith);
    ...
    await crudOperate.DeleteReservation(
    ...
    await crudOperate.DeleteCustomer(await context.Customers.FirstAsync(c => c.CustomerId == customerOne.CustomerId));
    Console.WriteLine("Customer in the reservations region got deleted successfully!");
    await crudOperate.DeleteRestaurant(
    ...
    await crudOperate.AddNewOrder(new Order()
    {
        OrderDate = dateFour,
    ...
    await crudOperate.DeleteOrder(await context.Orders.FirstAsync(o => o.OrderId == orderOne.OrderId));
    ...
    await crudOperate.AddNewOrder(initialOrder);
    ...
    await crudOperate.UpdateOrder(orderToUpdateWith);
    ...
    await crudOperate.DeleteCustomer(await context.Customers.FirstAsync(c => c.CustomerId == customerTwo!.CustomerId));
    Console.WriteLine("Customer in the orders region got deleted successfully!");
    await crudOperate.DeleteOrder(
    ...
    await crudOperate.DeleteReservation(await context.Reservations.FirstAsync(r => r.ReservationId == reservationTwo.ReservationId));
    ...
    await crudOperate.DeleteEmployee(
